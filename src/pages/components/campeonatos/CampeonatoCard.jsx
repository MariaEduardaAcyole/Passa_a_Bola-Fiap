  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'Inscrições Abertas':
        return 'bg-roxo text-white border-roxo';
      case 'Em Andamento':
    ...
    <div className="bg-white rounded-xl shadow-md p-6 mb-4 border border-gray-100 hover:shadow-lg transition-shadow duration-200">
        ...
        <div className="flex items-center text-gray-600">
          ...
          <span className="ml-2 text-sm">
            ...
            {campeonato.vagasDisponiveis > 0 && (
              <span className="text-roxo font-medium">
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
        ...
        {campeonato.status === 'Inscrições Abertas' && (
          <button className="px-4 py-2 bg-roxo text-white text-sm font-medium rounded-lg hover:bg-roxo transition-colors">
            Ver Detalhes
          </button>
        )}
      </div>
